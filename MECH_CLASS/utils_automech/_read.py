    ...
    if _inp_paths:
        for file_path, file_name in _inp_paths:
            if file_path.endswith('.xyz'):
                xyz_str = pathtools.read_file(file_path, file_name)
    ...
    if _inp_paths:
        for file_path, file_name in _inp_paths:
            if file_path.endswith('.asp'):
                aspace_str = pathtools.read_file(file_path, file_name)
